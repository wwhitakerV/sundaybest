...
import { QuickCheckScoreScreen } from "@/features/plans/screens/QuickCheckScoreScreen";
...
describe("QuickCheckScoreScreen", () => {
  it("is addressable as quick-check-score-screen", () => {
    render(<QuickCheckScoreScreen />);

    expect(screen.getByTestId("quick-check-score-screen")).toBeVisible();
  });
  ...
  it("navigates to Day Complete when Done is pressed", () => {
    render(<QuickCheckScoreScreen />);
